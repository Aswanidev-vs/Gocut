...
export function AnalyzeMotion(arg1:tracking.TrackingSettings):Promise<tracking.TrackingData>;

export function ApplyStabilization(arg1:string,arg2:tracking.TrackingData,arg3:string):Promise<void>;
...
export function GetSystemFonts():Promise<Array<project.FontInfo>>;

export function ImportLut(arg1:string):Promise<app.LutImportResult>;
